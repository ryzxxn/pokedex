        ...
        <div className="flex flex-[.1] max-h-[calc(100vh-80px)] absolute z-20">
          <div className="flex flex-col overflow-y-scroll static top-0">
            {PokemonData.map((item, index) => (
              <a href={`/pokemon/${index + 1}`} key={index} className="flex justify-between flex-row gap-1 text-white items-center p-2 static left-0 top-0 bg-[rgb(24,24,24)] hover:bg-[rgb(41,41,41)] transition-all cursor-pointer max-w-40">
